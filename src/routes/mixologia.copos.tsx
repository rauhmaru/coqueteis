...
export const Route = createFileRoute("/mixologia/copos")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Copos e taças — Mixologia" },
      { property: "og:description", content: "Highball, martini, old fashioned, canecas e demais copos usados na coquetelaria." },
