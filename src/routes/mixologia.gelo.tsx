...
export const Route = createFileRoute("/mixologia/gelo")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Gelo: de coadjuvante a estrela — Mixologia" },
      { property: "og:description", content: "O gelo dilui, resfria e transforma um coquetel — muito mais do que um simples acessório." },
