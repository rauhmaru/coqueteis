...
export const Route = createFileRoute("/mixologia/origem")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Origem e história — Mixologia" },
      { property: "og:description", content: "Da Grécia Antiga aos speakeasies dos anos 1920 e à renascença dos drinks — a história do coquetel." },
