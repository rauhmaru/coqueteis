...
export const Route = createFileRoute("/mixologia/xaropes")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Xaropes e bitters — Mixologia" },
      { property: "og:description", content: "Xaropes trazem cor e doçura; bitters trazem complexidade — os temperos do bartender." },
