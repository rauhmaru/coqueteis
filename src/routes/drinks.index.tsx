...
export const Route = createFileRoute("/drinks/")({
  ...
  loaderDeps: ({ search: { pagina, ordem } }) => ({ pagina, ordem }),
  loader: ({ context, deps }) =>
    Promise.all([
...
function DrinksList() {
  ...
  const { pagina, estoque: soPossiveis = false, ordem } = Route.useSearch();
                  ...
                  <li key={d.id} className="group rounded-xl border border-border bg-card overflow-hidden hover:border-primary/60 transition-colors relative">
                    ...
                    <Link to="/drinks/$id" params={{ id: drinkParam(d) }} className="block">
                      ...
                      <div className="p-3 sm:p-4">
                        <h2 className="font-serif text-base sm:text-xl text-foreground line-clamp-2">{d.nome}</h2>
                    ...
                    <div className="flex items-stretch">
                      <Link to="/drinks/$id" params={{ id: drinkParam(d) }} className="flex flex-1 items-center gap-4 p-3 min-w-0">
                        ...
                        <div className="min-w-0 flex-1">
                          <h2 className="font-serif text-lg sm:text-xl text-foreground truncate">{d.nome}</h2>
