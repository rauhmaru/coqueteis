...
export const Route = createFileRoute("/mixologia/materiais")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Materiais e utensílios — Mixologia" },
      { property: "og:description", content: "Coqueteleira, strainer, colher bailarina, jigger e demais utensílios do bartender." },
