...
export const Route = createFileRoute("/mixologia/bebidas")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Bebidas etílicas — Mixologia" },
      { property: "og:description", content: "Fermentadas, destiladas e infusionadas — as três grandes famílias do álcool." },
