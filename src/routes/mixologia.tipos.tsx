...
export const Route = createFileRoute("/mixologia/tipos")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "Tipos de coquetéis — Mixologia" },
      { property: "og:description", content: "Classificação dos coquetéis por método de preparo, volume, tipo de bebida e finalidade." },
